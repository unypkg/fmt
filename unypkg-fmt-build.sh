...
unyp install cmake ninja python
...
pkgname="fmt"
pkggit="https://github.com/fmtlib/fmt.git refs/tags/*"
gitdepth="--depth=1"
...
cmake -D CMAKE_INSTALL_PREFIX=/uny/pkg/"$pkgname"/"$pkgver" \
    -D CMAKE_INSTALL_LIBDIR=/uny/pkg/"$pkgname"/"$pkgver"/lib \
